    ...
    <div className=" py-16 md:py-32">
      <Wrapper className="flex flex-col gap-8">
        ...
        <div className="relative">
          ...
          <div className="md:mask-l-from-15% md:mask-l-to-55% mt-12 h-fit md:absolute md:-inset-y-36 md:inset-x-0 md:mt-0">
            <div className="w-full md:max-w-lg lg:max-w-xl ml-auto space-y-4">
